...
/*
  +----------------------------------------------------------------------+
  + GENERATED WITH PUPPET using /modules/apc/files/apc.php               +
  +----------------------------------------------------------------------+
  | APC                                                                  |
  +----------------------------------------------------------------------+
...
$VERSION='$Id: apc.php 5019 2011-12-23 16:05:36Z lorenzo.salvadorini $';
...
defaults('ADMIN_PASSWORD','password');  	// Admin Password
